...
public class ArrCharOps {
     ...
     */
    public static int indexOf(char[] arr, char ch, int startIndex) {
        startIndex = Math.max(0, Math.min(startIndex, arr.length - 1));
    ...
    */
    ...
    public static int compareTo(String str1, String str2) {
        ...
        for (int i = 0; i < minLength; i++) {
         ...
         return 1;   // longer string is greater
        }

        // 3. Same length and same characters
        return 0;
    }   
}